...
contract K613ArbitrumMarketInput is MarketInput {
  ...
  address private constant ARBITRUM_SEPOLIA_WETH = 0xC556bA1b7A820bD3b4C76D3FA8944d0E7F0E1F0e;
    ...
    )
  {
    ...
    // Note: RISK_ADMIN is not set here, use PostDeploySetup.sol to configure it
